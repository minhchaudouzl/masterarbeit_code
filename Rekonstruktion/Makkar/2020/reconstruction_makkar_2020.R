...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Makkar/2020")
...
# SAVR
data_rot <- data.frame(c(0, 60, data_rot$T_k), c(100, 43.4, data_rot$S_k))
...
write.csv2(data_rot, file = "makkar2020_savr.csv", row.names = FALSE)

tot.events_data_rot <- "NA" # 388
arm.id_data_rot <- 0


### Sortierung der blauen Daten
# TAVR
data_blau <- data.frame(c(0, 60, data_blau$T_k), c(100, 47.9, data_blau$S_k))
...
write.csv2(data_blau, file = "makkar2020_tavr.csv", row.names = FALSE)

tot.events_data_blau <- "NA" # 456
arm.id_data_blau <- 1
...
write.table(x = data_rot_guyot,
            file = "makkar2020_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "makkar2020_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
