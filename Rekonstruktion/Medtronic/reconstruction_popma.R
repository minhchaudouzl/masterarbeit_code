...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Medtronic")
...
write.csv2(data_rot, file = "popma_savr.csv", row.names = FALSE)

tot.events_data_rot <- 34
arm.id_data_rot <- 0
...
write.csv2(data_blau, file = "popma_tavr.csv", row.names = FALSE)

tot.events_data_blau <- 21
arm.id_data_blau <- 1
...
write.table(x = data_rot_guyot,
            file = "popma_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "popma_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
