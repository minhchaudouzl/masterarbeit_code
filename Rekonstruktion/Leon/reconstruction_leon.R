...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Leon")
...
write.csv2(data_rot, file = "leon_savr.csv", row.names = FALSE)

tot.events_data_rot <- "NA" # 202
arm.id_data_rot <- 0
...
write.csv2(data_blau, file = "leon_tavr.csv", row.names = FALSE)

tot.events_data_blau <- "NA" # 192
arm.id_data_blau <- 1
...
write.table(x = data_rot_guyot,
            file = "leon_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "leon_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
