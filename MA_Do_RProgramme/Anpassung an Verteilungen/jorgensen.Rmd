...
jorgensen_b <- read.csv2("Rekonstruktion/Jorgensen/blau.csv", sep = ";", header = FALSE)
jorgensen_r <- read.csv2("Rekonstruktion/Jorgensen/rot.csv", sep = ";", header = FALSE)
```
...
```{r jorgensenr getweibullpar, warning=FALSE, messages = FALSE, error=FALSE}
# Weibullverteilung
...
```{r jorgensenb getweibullpar, warning=FALSE, messages = FALSE, error=FALSE}
...
```{r jorgensenr getweibpar, warning=FALSE, messages = FALSE, error=FALSE}
# exponentiierte Weibullverteilung
...
weibbull_xr_jorgensen

plot(xr_jorgensen,
     pexpo.weibull(xr_jorgensen,
              alpha = weibbull_xr_jorgensen ["alpha"],
              theta = weibbull_xr_jorgensen ["theta"]), type = "l")
```

```{r jorgensen getweibpar, warning=FALSE, messages = FALSE, error=FALSE}
best_weibbull_xb_jorgensen <- find_best_start_2parameter(p = yb_jorgensen/100, 
                                                     q = xb_jorgensen,
                                                     max_beta = 10, 
                                                     max_eta = 10,
                                                     steps_beta = 1, 
...
weibbull_xb_jorgensen  <- getweibpar(
                        p = yb_jorgensen/100,
                        q = xb_jorgensen,
                        start = best_weibbull_xb_jorgensen,
                        show.output = TRUE,
                        plot = TRUE
                      )
weibbull_xb_jorgensen

plot(xb_jorgensen,
     pexpo.weibull(xb_jorgensen,
              alpha = weibbull_xb_jorgensen ["alpha"],
              theta = weibbull_xb_jorgensen ["theta"]), type = "l")
```


## Mischung aus Weibull- und Exponentialverteilung

```{r jorgensenr getweibex, warning=FALSE, messages = FALSE, error=FALSE}
# Mischung aus Weibull- und Exponentialverteilung
...
```{r jorgensenb getweibex, warning=FALSE, messages = FALSE, error=FALSE}
...
```{r jorgensenr get2weibex, warning=FALSE, messages = FALSE, error=FALSE}
# Mischung von exponentiierter Weibull- und Exponentialverteilung
...
```{r jorgensenb get2weibex, warning=FALSE, messages = FALSE, error=FALSE}
...
weibex2_xb_jorgensen <- get2weibex(
                        p = yb_jorgensen/100,
                        q = xb_jorgensen,
                        start = best_weibex2_xb_jorgensen,
                        show.output = TRUE,
                        plot = TRUE
                      )
...
```{r jorgensenr getexpweib, warning=FALSE, messages = FALSE, error=FALSE}
# exponentiierte Weibullverteilung ohne Lambda = 1
...
```{r jorgensenb getexpweib, warning=FALSE, messages = FALSE, error=FALSE}
...
```{r jorgensenr getstuexp3, warning=FALSE, messages = FALSE, error=FALSE}
# 3-Stufige Exponetialverteilung
...
```{r jorgensenb getstuexp3, warning=FALSE, messages = FALSE, error=FALSE}
...
```{r jorgensenr getstuexp2, warning=FALSE, messages = FALSE, error=FALSE}
# 2-Stufige Exponetialverteilung
...
```{r jorgensenb getstuexp2, warning=FALSE, messages = FALSE, error=FALSE}
...
```{r jorgensenr getexex, warning=FALSE, messages = FALSE, error=FALSE}
# Mischung aus 2 Exponentialverteilungen
...
exex_xr_jorgensen <- getexex(
                        p = yr_jorgensen/100,
                        q = xr_jorgensen,
                        start = best_exex_xr_jorgensen,
                        show.output = TRUE,
                        plot = TRUE
                      )
...
plot(xr_jorgensen,
     (exp(exex_xr_jorgensen["mix"]) / ( 1 + exp(exex_xr_jorgensen["mix"])) *  stats::pexp(q = xr_jorgensen,
                                                                            rate = exex_xr_jorgensen["rate1"]) +
...
```{r jorgensenb getexex, warning=FALSE, messages = FALSE, error=FALSE}
...
plot(xb_jorgensen,
     (exp(exex_xb_jorgensen["mix"]) / ( 1 + exp(exex_xb_jorgensen["mix"])) *  stats::pexp(q = xb_jorgensen,
                                                                            rate = exex_xb_jorgensen["rate1"]) +
...
```{r jorgensen_result, warning=FALSE, messages = FALSE, error=FALSE}
...
best_savr <- best_test(yb_jorgensen/100, xb_jorgensen, jorgensen_b_1, weibbull_xb_jorgensen, 
                       weibex_xb_jorgensen, weibex2_xb_jorgensen, expweib_xb_jorgensen, 
                       stuexp3_xb_jorgensen, stuexp2_xb_jorgensen, exex_xb_jorgensen, 
                       best_jorgensen_b_1, best_weibbull_xb_jorgensen, 
...
best_tavr <- best_test(yr_jorgensen/100, xr_jorgensen, jorgensen_r_1, weibbull_xr_jorgensen, 
                       weibex_xr_jorgensen, weibex2_xr_jorgensen, expweib_xr_jorgensen, 
                       stuexp3_xr_jorgensen, stuexp2_xr_jorgensen, exex_xr_jorgensen, 
                       best_jorgensen_r_1, best_weibbull_xr_jorgensen, 
