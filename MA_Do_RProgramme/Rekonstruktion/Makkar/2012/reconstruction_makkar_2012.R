...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Makkar/2012")
...
write.csv2(data_rot, file = "makkar2012_tavr.csv", row.names = FALSE)

tot.events_data_rot <- 82
arm.id_data_rot <- 1
...
write.csv2(data_blau, file = "makkar2012_savr.csv", row.names = FALSE)

tot.events_data_blau <- 117
arm.id_data_blau <- 0
...
write.table(x = data_rot_guyot,
            file = "makkar2012_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "makkar2012_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
