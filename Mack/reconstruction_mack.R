...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Mack")
...
write.csv2(data_rot, file = "mack_tavr.csv", row.names = FALSE)
...
write.csv2(data_blau, file = "mack_savr.csv", row.names = FALSE)
...
write.table(x = data_rot_guyot,
            file = "mack_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "mack_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
