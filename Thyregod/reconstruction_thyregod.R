...
setwd("D:/MA_Do_RProgramme/Masterarbeit/Rekonstruktion/Thyregod")
...
write.csv2(data_rot, file = "thyregod_savr.csv", row.names = FALSE)

tot.events_data_rot <- 49
arm.id_data_rot <- 0
...
write.csv2(data_blau, file = "thyregod_tavr.csv", row.names = FALSE)

tot.events_data_blau <- 55
arm.id_data_blau <- 1
...
write.table(x = data_rot_guyot,
            file = "thyregod_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "thyregod_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
