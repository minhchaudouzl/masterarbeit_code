...
setwd("D:/MA_Do_RProgramme/Rekonstruktion/Gleason")
...
write.csv2(data_rot, file = "gleason_savr.csv", row.names = FALSE)

tot.events_data_rot <- 184
arm.id_data_rot <- 0
...
write.csv2(data_blau, file = "gleason_tavr.csv", row.names = FALSE)

tot.events_data_blau <- 208
arm.id_data_blau <- 1
...
write.table(x = data_rot_guyot,
            file = "gleason_rot_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)

write.table(x = data_blau_guyot,
            file = "gleason_blau_guyot.csv",
            sep = ";",
            row.names = FALSE,
            col.names = FALSE)
